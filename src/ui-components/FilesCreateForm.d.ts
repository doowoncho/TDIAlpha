...
export declare type FilesCreateFormInputValues = {
    photo_name?: string;
    photo_file?: string;
    permit_name?: string;
    permit_file?: string;
...
export declare type FilesCreateFormValidationValues = {
...
export declare type FilesCreateFormOverridesProps = {
    FilesCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type FilesCreateFormProps = React.PropsWithChildren<{
    overrides?: FilesCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: FilesCreateFormInputValues) => FilesCreateFormInputValues;
    onSuccess?: (fields: FilesCreateFormInputValues) => void;
    onError?: (fields: FilesCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: FilesCreateFormInputValues) => FilesCreateFormInputValues;
    onValidate?: FilesCreateFormValidationValues;
} & React.CSSProperties>;
export default function FilesCreateForm(props: FilesCreateFormProps): React.ReactElement;
