...
import { createFiles } from "../graphql/mutations";
const client = generateClient();
export default function FilesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setPhoto_name(initialValues.photo_name);
    setPhoto_file(initialValues.photo_file);
    setPermit_name(initialValues.permit_name);
    setPermit_file(initialValues.permit_file);
    setPermit_confirmation_name(initialValues.permit_confirmation_name);
    setPermit_confirmation_file(initialValues.permit_confirmation_file);
    setMap_drawing_name(initialValues.map_drawing_name);
    setMap_file(initialValues.map_file);
    setErrors({});
  };
  const validations = {
    photo_name: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createFiles.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "FilesCreateForm")}
      {...rest}
    >
      <TextField
        label="Photo name"
